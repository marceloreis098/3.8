  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err instanceof TypeError && err.message.includes('Failed to fetch')) {
        setError('Falha de conexão com a API. Verifique a configuração do servidor (reverse proxy) e se o backend está em execução.');
      } else {
