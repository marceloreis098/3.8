  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err instanceof TypeError && err.message.includes('Failed to fetch')) {
        setError('Falha de conexão com a API. Verifique se o servidor backend está em execução.');
      } else {
